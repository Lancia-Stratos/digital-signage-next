...
import { SidebarProvider, SidebarTrigger, SidebarGroupLabel } from "@/components/ui/sidebar"
    ...
    >
      ...
      <main className="w-full h-full">
        ...
        <div className="flex bg-gray-100 min-h-screen w-full">
          ...
          <div className="ml-2">
            <div className="">
              <SidebarGroupLabel className="flex items-center">{String(metadata.title)}</SidebarGroupLabel>
              {children}
            </div>
          </div>
        </div>
